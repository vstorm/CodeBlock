# Django settings for codeblock project.
...
SECRET_KEY = 'epe-c$cmkz)(%y^8_unn7ue-&@olh=6brc%d^2vsig9*=+btf*'
...
ROOT_URLCONF = 'codeblock.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'codeblock.wsgi.application'
